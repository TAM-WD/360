...
- [logout_of_blocked_users](https://github.com/TAM-WD/360/blob/main/logout_of_blocked_users.py) - глобальный логаут для всех заблокированных пользователей в организации.
...
- [Activity Checker](https://github.com/TAM-WD/360/tree/main/Activity_Checker) – cкрипт возвращает SCV файл с датой и временем последнего события авторизации, Почты и Диска для каждого сотрудника организации.
