...
- [https://github.com/TAM-WD/360/blob/main/API/Tracker/delete_links_multithreading.py](delete_links_multithreading.py) - удаление связей задач по списку из консоли браузера
- [https://github.com/TAM-WD/360/blob/main/API/Tracker/get_fields_with_filter.py](get_fields_with_filter.py) - выгрузка глобальных полей в csv с фильтром
