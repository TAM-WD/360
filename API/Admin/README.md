...
- [get_list_of_users_groups_departments.py](https://github.com/TAM-WD/360/blob/main/API/Admin/get_list_of_users_groups_departments.py) - получение списка пользователей, групп и подразделений организации.
