# Описание
- [delete_oldexe_telemost.ps1](https://github.com/TAM-WD/360/blob/main/misc/delete_oldexe_telemost.ps1) - удалить старый exe клиент Телемоста и сменить клиент для открытия ссылок.
