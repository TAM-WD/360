...
FILE_NAME = '' # Только CSV файл; имя файла без расширения; должен лежать в той же папке, что и скрипт. Формат - в заголовках user_id должен быть в колонке "id", разделитель - ";" точка с запятой
        ...
        for user in users:
            if int(user) > 1130000000000000:
                ...
                if is_active == False:
                    ...
                    print(f"User {user} is active, skipping")
    print('Complete')